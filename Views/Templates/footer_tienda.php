		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-lg-4 p-b-50">
					...
					<div class="p-t-27">
    <a href="https://www.facebook.com/csn.compusoftnet" class="fs-18 cl7 hov-cl1 trans-04 m-r-16" target="_blank">
        <i class="fa fa-facebook"></i>
    </a>

    <a href="https://www.instagram.com/csn.ec/" class="fs-18 cl7 hov-cl1 trans-04 m-r-16" target="_blank">
        <i class="fa fa-instagram"></i>
			...
			<div class="p-t-40">
				...
				<p class="stext-107 cl6 txt-center">
					...
					</script> Todo los derechos reservados CompuSoftNet CIA LTDA.</i> 
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
