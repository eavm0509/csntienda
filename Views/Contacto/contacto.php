...
<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url(<?= $banner ?>);">
	<h2 class="ltext-105 txt-center" style="color: black; font-weight: bold;">
		Contacto
	</h2>
</section>
			...
			<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
				<form id="frmContacto">
					...
					<div class="bor8 m-b-20 how-pos4-parent">
						...
						<img class="how-pos4 pointer-none" src="<?= media() ?>/tienda/images/icons/icon-next.png" alt="ICON" style="width: 28px;">
					</div>
				...
				<div class="flex-w w-full p-b-42">
					...
					<div class="size-212 p-t-2">
						...
						<p class="stext-115 cl1 size-213 p-t-18">
							...
							<a class="" href="tel:<?= TELEMPRESA1 ?>"><?= TELEMPRESA1 ?></a><br>
							<a class="" href="tel:<?= TELEMPRESA2 ?>"><?= TELEMPRESA2 ?></a>
						</p>
					</div>
				</div>
